...
class _CartPageState extends State<CartPage> {
      ...
      AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text('Your materials have been added to your account!'),
            SizedBox(height: 8),
            Text('You can now access them from your profile.'),
          ],
        ),
        actions: [
          TextButton(
  ...
  Future<String?> _createOrder(double amount) async {
    try {
      ...
      final keyId = 'rzp_test_IGJRjtFqEWWxfG';
      final keySecret = 'APfmJTwunoIdYYJVkDbkNA3b';
